    ...
    create: {
      ...
      result: {
        create: {
          ...
          dimensions: [
            { key: "discovery", score: 72, weight: 30 },
            { key: "trust", score: 64, weight: 40 },
            { key: "contact", score: 70, weight: 30 },
          ],
          evidence: [
            {
        ...
        create: [
          {
            ...
            rationale: "Informações completas reduzem dúvidas antes do contato.",
