        ...
        <CardContent>
          <BusinessForm
            defaultValues={{
              ...
              googleMaps: getChannelValue(business?.channels ?? [], "GOOGLE_MAPS"),
              website: getChannelValue(business?.channels ?? [], "WEBSITE"),
              whatsapp: getChannelValue(business?.channels ?? [], "WHATSAPP"),
            }}
          />
        </CardContent>
      </Card>
