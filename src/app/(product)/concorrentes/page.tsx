                      ...
                      <div className="mt-5 border-t pt-5">
                        <CompetitorForm
                          ...
                          defaultValues={{
                            ...
                            googleMaps: getChannelValue(competitor.channels, "GOOGLE_MAPS"),
                            website: getChannelValue(competitor.channels, "WEBSITE"),
                            whatsapp: getChannelValue(competitor.channels, "WHATSAPP"),
                          }}
                        />
                      </div>
                    </details>
