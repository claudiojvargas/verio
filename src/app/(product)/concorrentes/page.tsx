...
import { getChannelValue } from "@/modules/businesses/application/channel-values";
import {
  CompetitorForm,
        ...
        <Card>
          <CardContent className="flex flex-col items-center py-12 text-center">
            ...
            <p className="mt-1 max-w-md text-sm text-muted-foreground">
              Precisamos saber qual é a sua empresa antes de relacionar
              concorrentes.
            </p>
                      ...
                      <div className="mt-5 border-t pt-5">
                        <CompetitorForm
                          ...
                          defaultValues={{
                            ...
                            googleMaps: getChannelValue(
                              competitor.channels,
                              "GOOGLE_MAPS",
                            ),
                            website: getChannelValue(
                              competitor.channels,
                              "WEBSITE",
                            ),
                            whatsapp: getChannelValue(
                              competitor.channels,
                              "WHATSAPP",
                            ),
                          }}
          ...
          {canAdd ? (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Informe ao menos um canal para permitir uma comparação
                  auditável.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-dashed">
              <CardContent className="py-8 text-center text-sm text-muted-foreground">
                Você atingiu o limite de três concorrentes do MVP. Remova um
